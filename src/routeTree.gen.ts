...
export interface FileRoutesByFullPath {
  ...
  '/_authenticated/prehled': typeof AuthenticatedPrehledRoute
}
...
export interface FileRouteTypes {
  ...
  fullPaths: '/' | '/instrumenty' | '/kurzy' | '/lekce/$slug' | '/slovnik' | '/styly' | '/auth' | '/reset-password' | '/_authenticated/admin' | '/_authenticated/prehled'
  fileRoutesByTo: FileRoutesByTo
  to: '/' | '/instrumenty' | '/kurzy' | '/lekce/$slug' | '/slovnik' | '/styly' | '/auth' | '/reset-password' | '/admin' | '/prehled'
  id: '__root__' | '/' | '/instrumenty' | '/kurzy' | '/lekce/$slug' | '/slovnik' | '/styly' | '/auth' | '/reset-password' | '/_authenticated' | '/_authenticated/admin' | '/_authenticated/prehled'
